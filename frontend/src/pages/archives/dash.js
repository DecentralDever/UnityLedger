...
const Dashboard = () => {
    ...
    return (_jsxs("div", { className: "w-full max-w-7xl mx-auto px-4 sm:px-6 py-8", children: [_jsxs(motion.section, { className: "relative rounded-2xl overflow-hidden mb-12", initial: "hidden", animate: "visible", variants: fadeInUp, children: [_jsx("div", { className: `absolute inset-0 ${isDark
                    ...
                    ].map((stat, index) => (_jsx(motion.div, { variants: fadeIn, whileHover: { scale: 1.03, y: -5 }, className: "bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm border border-gray-100 dark:border-gray-700 transition-all", children: _jsxs("div", { className: "flex items-center gap-4", children: [_jsx("div", { className: `${stat.bg} p-3 rounded-lg`, children: stat.icon }), _jsxs("div", { children: [_jsx("p", { className: "text-gray-500 dark:text-gray-400 text-sm", children: stat.title }), _jsxs("div", { className: "flex items-end gap-2", children: [_jsx("h3", { className: "text-2xl font-bold text-gray-900 dark:text-white", children: stat.value }), _jsx("span", { className: "text-xs font-medium text-green-600 dark:text-green-400", children: stat.change })] })] })] }) }, index))) }) }), _jsxs(motion.section, { initial: "hidden", animate: "visible", variants: fadeInUp, transition: { delay: 0.4 }, className: "mb-12", children: [_jsxs("div", { className: "flex justify-between items-center mb-6", children: [_jsx("h2", { className: "text-2xl font-bold text-gray-800 dark:text-white", children: isLoading ? (_jsx("div", { className: "bg-gray-200 dark:bg-gray-700 animate-pulse h-8 w-40 rounded" })) : (_jsxs("span", { className: "flex items-center", children: ["Explore ", _jsx("span", { className: "text-indigo-600 dark:text-indigo-400 mx-1", children: poolCount || 0 }), " Available Pools"] })) }), _jsxs("a", { href: "/join-create", className: "inline-flex items-center text-indigo-600 dark:text-indigo-400 hover:text-indigo-800 dark:hover:text-indigo-300 font-medium transition-colors", children: ["Create New Pool", _jsx(ArrowRight, { size: 16, className: "ml-1" })] })] }), _jsx(AnimatePresence, { children: isLoading ? (_jsx(motion.div, { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6", exit: { opacity: 0 }, children: [1, 2, 3].map((i) => (_jsxs("div", { className: "bg-white dark:bg-gray-800 rounded-xl p-6 h-64 shadow-sm animate-pulse", children: [_jsx("div", { className: "bg-gray-200 dark:bg-gray-700 h-6 w-1/3 mb-4 rounded" }), _jsx("div", { className: "bg-gray-200 dark:bg-gray-700 h-4 w-2/3 mb-2 rounded" }), _jsx("div", { className: "bg-gray-200 dark:bg-gray-700 h-4 w-1/2 mb-6 rounded" }), _jsxs("div", { className: "flex gap-3 mb-6", children: [_jsx("div", { className: "bg-gray-200 dark:bg-gray-700 h-10 w-20 rounded-full" }), _jsx("div", { className: "bg-gray-200 dark:bg-gray-700 h-10 w-20 rounded-full" })] }), _jsx("div", { className: "bg-gray-200 dark:bg-gray-700 h-20 w-full rounded" })] }, i))) })) : (_jsxs(motion.div, { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6", initial: { opacity: 0 }, animate: { opacity: 1 }, transition: { duration: 0.5 }, children: [_jsx(PoolSelector, {}), _jsxs(motion.div, { whileHover: { scale: 1.02, y: -5 }, className: "bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm border border-gray-100 dark:border-gray-700 transition-all", children: [_jsxs("div", { className: "flex justify-between items-start mb-4", children: [_jsxs("div", { children: [_jsx("span", { className: "inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-green-100 dark:bg-green-900 text-green-800 dark:text-green-300", children: "Featured" }), _jsx("h3", { className: "text-lg font-semibold mt-2 text-gray-900 dark:text-white", children: "Community Savings Pool" })] }), _jsx("div", { className: "bg-indigo-100 dark:bg-indigo-900/50 p-2 rounded-lg", children: _jsx(PieChart, { size: 20, className: "text-indigo-600 dark:text-indigo-400" }) })] }), _jsx("p", { className: "text-sm text-gray-600 dark:text-gray-300 mb-4", children: "Our most popular rotating savings pool with weekly contributions and monthly payouts." }), _jsxs("div", { className: "flex flex-wrap gap-2 mb-4", children: [_jsx("span", { className: "px-2 py-1 rounded-md text-xs font-medium bg-blue-100 dark:bg-blue-900/50 text-blue-800 dark:text-blue-300", children: "15 Members" }), _jsx("span", { className: "px-2 py-1 rounded-md text-xs font-medium bg-purple-100 dark:bg-purple-900/50 text-purple-800 dark:text-purple-300", children: "3.2% APY" }), _jsx("span", { className: "px-2 py-1 rounded-md text-xs font-medium bg-amber-100 dark:bg-amber-900/50 text-amber-800 dark:text-amber-300", children: "USDC" })] }), _jsxs("div", { className: "grid grid-cols-2 gap-3 mt-6", children: [_jsx("span", { className: "text-xs text-gray-500 dark:text-gray-400", children: "Pool value" }), _jsx("span", { className: "text-xs text-gray-900 dark:text-white font-medium text-right", children: "$45,600" }), _jsx("span", { className: "text-xs text-gray-500 dark:text-gray-400", children: "Min. contribution" }), _jsx("span", { className: "text-xs text-gray-900 dark:text-white font-medium text-right", children: "$100/week" }), _jsx("span", { className: "text-xs text-gray-500 dark:text-gray-400", children: "Next payout" }), _jsx("span", { className: "text-xs text-gray-900 dark:text-white font-medium text-right", children: "3 days" })] }), _jsx(motion.button, { whileHover: { scale: 1.03 }, whileTap: { scale: 0.98 }, className: "w-full mt-6 bg-indigo-600 hover:bg-indigo-700 text-white py-2 rounded-lg font-medium text-sm transition-colors", children: "Join Pool" })] }), _jsxs(motion.div, { whileHover: { scale: 1.02, y: -5 }, className: "bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm border border-gray-100 dark:border-gray-700 transition-all", children: [_jsxs("div", { className: "flex justify-between items-start mb-4", children: [_jsxs("div", { children: [_jsx("span", { className: "inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-purple-100 dark:bg-purple-900 text-purple-800 dark:text-purple-300", children: "New" }), _jsx("h3", { className: "text-lg font-semibold mt-2 text-gray-900 dark:text-white", children: "Modern Stokvel" })] }), _jsx("div", { className: "bg-purple-100 dark:bg-purple-900/50 p-2 rounded-lg", children: _jsx(Users, { size: 20, className: "text-purple-600 dark:text-purple-400" }) })] }), _jsx("p", { className: "text-sm text-gray-600 dark:text-gray-300 mb-4", children: "Join our modern take on traditional stokvels with flexible contributions and emergency loans." }), _jsxs("div", { className: "flex flex-wrap gap-2 mb-4", children: [_jsx("span", { className: "px-2 py-1 rounded-md text-xs font-medium bg-blue-100 dark:bg-blue-900/50 text-blue-800 dark:text-blue-300", children: "8 Members" }), _jsx("span", { className: "px-2 py-1 rounded-md text-xs font-medium bg-purple-100 dark:bg-purple-900/50 text-purple-800 dark:text-purple-300", children: "4.5% APY" }), _jsx("span", { className: "px-2 py-1 rounded-md text-xs font-medium bg-amber-100 dark:bg-amber-900/50 text-amber-800 dark:text-amber-300", children: "DAI" })] }), _jsxs("div", { className: "grid grid-cols-2 gap-3 mt-6", children: [_jsx("span", { className: "text-xs text-gray-500 dark:text-gray-400", children: "Pool value" }), _jsx("span", { className: "text-xs text-gray-900 dark:text-white font-medium text-right", children: "$32,200" }), _jsx("span", { className: "text-xs text-gray-500 dark:text-gray-400", children: "Min. contribution" }), _jsx("span", { className: "text-xs text-gray-900 dark:text-white font-medium text-right", children: "$50/week" }), _jsx("span", { className: "text-xs text-gray-500 dark:text-gray-400", children: "Next payout" }), _jsx("span", { className: "text-xs text-gray-900 dark:text-white font-medium text-right", children: "12 days" })] }), _jsx(motion.button, { whileHover: { scale: 1.03 }, whileTap: { scale: 0.98 }, className: "w-full mt-6 bg-purple-600 hover:bg-purple-700 text-white py-2 rounded-lg font-medium text-sm transition-colors", children: "Join Pool" })] })] })) })] }), _jsxs(motion.section, { initial: "hidden", animate: "visible", variants: fadeInUp, transition: { delay: 0.6 }, children: [_jsxs("div", { className: "flex justify-between items-center mb-6", children: [_jsx("h2", { className: "text-2xl font-bold text-gray-800 dark:text-white", children: "Recent Activity" }), _jsxs("a", { href: "/activity", className: "inline-flex items-center text-indigo-600 dark:text-indigo-400 hover:text-indigo-800 dark:hover:text-indigo-300 font-medium transition-colors", children: ["View All", _jsx(ArrowRight, { size: 16, className: "ml-1" })] })] }), _jsx("div", { className: "bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700", children: _jsx("ul", { className: "divide-y divide-gray-100 dark:divide-gray-700", children: activities.map((activity) => (_jsx(motion.li, { whileHover: { backgroundColor: isDark ? 'rgba(255,255,255,0.03)' : 'rgba(0,0,0,0.01)' }, className: "px-6 py-4", children: _jsxs("div", { className: "flex items-center", children: [_jsx("div", { className: "flex-shrink-0", children: activity.icon }), _jsxs("div", { className: "ml-4", children: [_jsxs("p", { className: "text-sm font-medium text-gray-900 dark:text-white", children: [activity.type === 'deposit' && 'Deposit to', activity.type === 'withdrawal' && 'Withdrawal from', activity.type === 'payout' && 'Payout from', ' ', _jsxs("span", { className: "text-indigo-600 dark:text-indigo-400", children: ["Pool #", activity.pool] })] }), _jsxs("p", { className: "text-xs text-gray-500 dark:text-gray-400", children: [activity.user, " \u2022 ", activity.amount] })] }), _jsx("div", { className: "ml-auto", children: _jsxs("div", { className: "flex items-center", children: [_jsx(Clock, { size: 12, className: "text-gray-400 mr-1" }), _jsx("span", { className: "text-xs text-gray-500 dark:text-gray-400", children: activity.time })] }) })] }) }, activity.id))) }) })] }), _jsx(motion.section, { className: "mt-16 mb-8", initial: "hidden", animate: "visible", variants: fadeInUp, transition: { delay: 0.8 }, children: _jsxs("div", { className: `relative rounded-2xl overflow-hidden ${isDark ? 'bg-gradient-to-r from-purple-900 to-indigo-900'
                        : 'bg-gradient-to-r from-purple-600 to-indigo-600'}`, children: [_jsx("div", { className: "absolute inset-0 bg-[url('/images/dots-pattern.svg')] opacity-10" }), _jsxs("div", { className: "relative z-10 p-8 md:p-12 text-center", children: [_jsx("h2", { className: "text-3xl font-bold text-white mb-4", children: "Ready to Transform Your Savings?" }), _jsx("p", { className: "text-white/80 max-w-2xl mx-auto mb-8", children: "Join thousands of people who are already using UnityLedger to build wealth together through decentralized stokvels and savings pools." }), _jsxs("div", { className: "flex flex-col sm:flex-row gap-4 justify-center", children: [_jsx(motion.button, { whileHover: { scale: 1.05 }, whileTap: { scale: 0.95 }, className: "bg-white text-indigo-700 font-semibold py-3 px-8 rounded-lg shadow-lg", children: "Get Started" }), _jsx(motion.button, { whileHover: { scale: 1.05 }, whileTap: { scale: 0.95 }, className: "bg-transparent border border-white text-white font-semibold py-3 px-8 rounded-lg", children: "Learn More" })] })] })] }) }), _jsxs("footer", { className: "mt-16 mb-8 pt-8 border-t border-gray-200 dark:border-gray-700", children: [_jsxs("div", { className: "grid grid-cols-2 md:grid-cols-4 gap-8", children: [_jsxs("div", { children: [_jsx("h4", { className: "font-medium text-gray-900 dark:text-white mb-4", children: "Product" }), _jsxs("ul", { className: "space-y-2", children: [_jsx("li", { children: _jsx("a", { href: "#", className: "text-sm text-gray-600 dark:text-gray-400 hover:text-indigo-600 dark:hover:text-indigo-400", children: "Features" }) }), _jsx("li", { children: _jsx("a", { href: "#", className: "text-sm text-gray-600 dark:text-gray-400 hover:text-indigo-600 dark:hover:text-indigo-400", children: "Roadmap" }) }), _jsx("li", { children: _jsx("a", { href: "#", className: "text-sm text-gray-600 dark:text-gray-400 hover:text-indigo-600 dark:hover:text-indigo-400", children: "Security" }) }), _jsx("li", { children: _jsx("a", { href: "#", className: "text-sm text-gray-600 dark:text-gray-400 hover:text-indigo-600 dark:hover:text-indigo-400", children: "Pricing" }) })] })] }), _jsxs("div", { children: [_jsx("h4", { className: "font-medium text-gray-900 dark:text-white mb-4", children: "Resources" }), _jsxs("ul", { className: "space-y-2", children: [_jsx("li", { children: _jsx("a", { href: "#", className: "text-sm text-gray-600 dark:text-gray-400 hover:text-indigo-600 dark:hover:text-indigo-400", children: "Documentation" }) }), _jsx("li", { children: _jsx("a", { href: "#", className: "text-sm text-gray-600 dark:text-gray-400 hover:text-indigo-600 dark:hover:text-indigo-400", children: "Guides" }) }), _jsx("li", { children: _jsx("a", { href: "#", className: "text-sm text-gray-600 dark:text-gray-400 hover:text-indigo-600 dark:hover:text-indigo-400", children: "Support" }) }), _jsx("li", { children: _jsx("a", { href: "#", className: "text-sm text-gray-600 dark:text-gray-400 hover:text-indigo-600 dark:hover:text-indigo-400", children: "API" }) })] })] }), _jsxs("div", { children: [_jsx("h4", { className: "font-medium text-gray-900 dark:text-white mb-4", children: "Company" }), _jsxs("ul", { className: "space-y-2", children: [_jsx("li", { children: _jsx("a", { href: "#", className: "text-sm text-gray-600 dark:text-gray-400 hover:text-indigo-600 dark:hover:text-indigo-400", children: "About" }) }), _jsx("li", { children: _jsx("a", { href: "#", className: "text-sm text-gray-600 dark:text-gray-400 hover:text-indigo-600 dark:hover:text-indigo-400", children: "Blog" }) }), _jsx("li", { children: _jsx("a", { href: "#", className: "text-sm text-gray-600 dark:text-gray-400 hover:text-indigo-600 dark:hover:text-indigo-400", children: "Jobs" }) }), _jsx("li", { children: _jsx("a", { href: "#", className: "text-sm text-gray-600 dark:text-gray-400 hover:text-indigo-600 dark:hover:text-indigo-400", children: "Partners" }) })] })] }), _jsxs("div", { children: [_jsx("h4", { className: "font-medium text-gray-900 dark:text-white mb-4", children: "Legal" }), _jsxs("ul", { className: "space-y-2", children: [_jsx("li", { children: _jsx("a", { href: "#", className: "text-sm text-gray-600 dark:text-gray-400 hover:text-indigo-600 dark:hover:text-indigo-400", children: "Privacy" }) }), _jsx("li", { children: _jsx("a", { href: "#", className: "text-sm text-gray-600 dark:text-gray-400 hover:text-indigo-600 dark:hover:text-indigo-400", children: "Terms" }) }), _jsx("li", { children: _jsx("a", { href: "#", className: "text-sm text-gray-600 dark:text-gray-400 hover:text-indigo-600 dark:hover:text-indigo-400", children: "Cookies" }) }), _jsx("li", { children: _jsx("a", { href: "#", className: "text-sm text-gray-600 dark:text-gray-400 hover:text-indigo-600 dark:hover:text-indigo-400", children: "Licenses" }) })] })] })] }), _jsx("div", { className: "mt-12 text-center", children: _jsx("p", { className: "text-sm text-gray-500 dark:text-gray-400", children: "\u00A9 2025 UnityLedger. All rights reserved." }) })] })] }));
};
