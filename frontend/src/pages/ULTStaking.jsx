...
const ULTStaking = () => {
  ...
  // Determine ULT token address based on the connected chain
  ...
  // Instantiate the ULT contract for the current network
  ...
  // Effects: load data on account change & auto-refresh every 30s
  useEffect(() => {
    loadStakingData();
  }, [account]);
